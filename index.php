...
if(isset($_POST['submit'])){
	...
	$hello=mysqli_real_escape_string($_POST['hello']);
	$hi=mysqli_real_escape_string($_POST['hi']);
	$bye=mysqli_real_escape_string($_POST['bye']);
	...
	if($emailcount>0)
	{
		...
		if($hi===$bye)
		{
		$insertquery="INSERT into contract(naam, email, pwd, fp) VALUES ('$username', '$hello', '$hi', '$bye')";
